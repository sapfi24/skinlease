      ...
      <div className="container hero-grid">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Готовые сеты по выгодным ценам.
            Выбирайте понравившийся сет, оформляйте аренду
            и играйте без покупки всего инвентаря.<br />
            (Если у вас не загружаются фотографии, либо сайт работает нестабильно, используйте VPN.)
          </p>
